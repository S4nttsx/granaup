      ...
      <aside className={cn(
        ...
        <div className="flex flex-col h-full">
          <div className="p-6 flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-emerald-600 dark:text-emerald-400">GranaUp</h1>
          </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 flex items-center justify-between px-6 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 lg:hidden">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-emerald-600 dark:text-emerald-400">GranaUp</span>
          </div>
          <button 
